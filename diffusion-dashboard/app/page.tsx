...
export default function Home() {
  ...
  const [layers, setLayers] = useState<Record<string, boolean>>({ state: true, ellipses: true, waypoints: true, result: false, groundTruth: false, map: true, almRaw: true, almRegions: true });

  ...
  return <main className="min-h-screen bg-background text-foreground">
    ...
    <div className="workspace">
      ...
      <section className="stage-column">
        ...
        <p className="method-note">“x₀ prediction”展示每个 timestep 模型刚输出的 P̂₀⁽ᵗ⁾ / Ê₀⁽ᵗ⁾；“noisy state”展示送入模型的 Pₜ / Eₜ。V3 每步重选骨架候选：浅蓝虚线是当前 occupancy/起终点下的搜索路径，深蓝实线是选中的拓扑；粉色虚线是椭圆条件化前的主干 x̂₀。椭圆颜色由浅到深表示它们沿轨迹的顺序（起点→终点）。</p>
      </section>
